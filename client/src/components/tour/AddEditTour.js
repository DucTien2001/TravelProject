...
const AddEditTour = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (
            ...
            const updatedTourData = { ...tourData, state: "on sale", name: user?.result?.name };
            if (!id) {
                    ...
                    >
                        ...
                        <div className="col-md-12">
                            <MDBInput
                                ...
                                required
                                invalid
                                validation="Please provide business hours"
                            />
                        </div>
                        <div className="col-md-12">
                            <MDBInput
                        ...
                        <div className="col-md-12">
                            <MDBInput
                                ...
                                required
                                invalid
                                validation="Please provide contact"
                            />
                        </div>
                        <div className="col-md-12">
                            <MDBInput
                        ...
                        <div className="col-md-12">
                            <MDBInput
                                ...
                                required
                                invalid
                                validation="Please provide discount"
                            />
                        </div>
                        <div className="col-md-12">
                            <ChipInput
